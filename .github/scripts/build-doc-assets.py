...
def profile(version):
    ...
    schemas['IrrigationSnapshot'] = obj(irrigation, ['last_refresh_epoch', 'zones', 'water_plan'], description='Selected fields from the full irrigation snapshot. Read observation ages independently of snapshot age.')
